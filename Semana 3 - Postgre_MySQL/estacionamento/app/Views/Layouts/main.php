...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('public/assets/toastify/toastify.css'); ?>>
...
<div class="container-scroller"> 
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item nav-category">Categorias</li>
          <li class="nav-item">
  ...
  <script src="<?php echo base_url('public/assets/toastify/toastify.js'); ?>></script>
